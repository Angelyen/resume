...
public class Pokemon implements Fight, Serializable {
     ...
     */
    public Pokemon(int image,int back, String name, String yell, int level, int stamina, int attack, int defense, int catchChance, Move fastMove, Move chargeMove) {
        this.image = image;
        this.back = back;
        this.name = name;
        this.yell = yell;
    ...
    public static List<Pokemon> getFieldPokemons() {
        ...
        Pokemon greenbird = new Pokemon(R.drawable.greenbird,
                R.drawable.greenbirdback,
                "青綿鳥",
                "青綿",
                1,
                90,
        ...
        Pokemon slowpoke = new Pokemon(R.drawable.slowpoke,
                R.drawable.slowpokeback,
                "呆呆獸",
                "呆呆",
                1,
                180,
        ...
        Pokemon loong = new Pokemon(R.drawable.loong,
                R.drawable.longback,
                "溶食獸",
                "溶食",
                1,
        ...
        Pokemon bokpe = new Pokemon(R.drawable.bokpe,
                R.drawable.bokpeback,
                "波克比",
                "波克",
                1,
                70,
        ...
        Pokemon pee = new Pokemon(R.drawable.pee,
                R.drawable.peeback,
                "皮寶寶",
                "皮皮",
                1,
