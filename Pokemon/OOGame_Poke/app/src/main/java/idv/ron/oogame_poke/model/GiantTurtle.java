...
public class GiantTurtle extends Pokemon {
     ...
     */
    public GiantTurtle(int image, int back, String name,String yell, int level, int stamina, int attack, int defense, int catchChance, Move fastMove, Move chargeMove) {
